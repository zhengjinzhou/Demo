...
import zhou.com.demo.view.recyclerview.EasyRecyclerView;
import zhou.com.demo.view.recyclerview.OnLoadMoreListener;
import zhou.com.demo.view.recyclerview.RecyclerArrayAdapter;
import zhou.com.demo.view.recyclerview.swipe.OnRefreshListener;

/**
 * Created by zhou on 2018/2/27.
 */

public abstract class BaseRVFragment <T2> extends BaseFragment implements OnLoadMoreListener,OnRefreshListener,RecyclerArrayAdapter.OnItemClickListener {
